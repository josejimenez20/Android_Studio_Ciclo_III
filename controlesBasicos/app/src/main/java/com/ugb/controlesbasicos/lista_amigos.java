...
public class lista_amigos extends AppCompatActivity {
    ...
    public void onCreateContextMenu(ContextMenu menu, View v, ContextMenu.ContextMenuInfo menuInfo) {
        ...
        menu.setHeaderTitle(cAmigos.getString(1));//1 = nombre
    }
    @Override
        ...
        try {
            switch (item.getItemId()){
                ...
                case R.id.mnxEliminar:
                    // Obtiene el ID del contacto que se va a eliminar
                    String idContacto = cAmigos.getString(0); // Ajusta esto según la posición real del ID en tu cursor
